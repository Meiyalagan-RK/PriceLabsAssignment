...
describe('Remove Custom Pricing API', () => {
    ...
    // Endpoint for removing custom pricing and reading calendar data
      const addEndpoint = 'https://app.pricelabs.co/api/add_custom_pricing'
    ...
    // Group of tests for remove pricing API behaviours
    context('Remove pricing API validations', () => {
        //addded to price update 
        
        // it('Validate custom pricing should be removed from DSO listing for par', () => {
        //     const payload = {
        ...
        it('Validate no listing id found payload pricing removal endpoint', () => {
            const payload = {
        ...
        // invalid payload should return 404 style error in body
        it('Validate invalid payload pricing removal endpoint', () => {
            const payload = {
                ...payloads.emptyPriceUpdate,
            }
